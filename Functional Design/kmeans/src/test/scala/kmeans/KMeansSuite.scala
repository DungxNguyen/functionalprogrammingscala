...
class KMeansSuite extends FunSuite {
  ...
  test("website test") {
     assert(kMeans(Vector(new Point(0.0, 0.0, 1.0), new Point(0.0, 0.0, -1.0), new Point(0.0, 1.0, 0.0), new Point(0.0, 10.0, 0.0)), Vector(new Point( 0, -1, 0), new Point(0, 2, 0)), 12.25) == Vector(new Point(0.0, 0.0, 0.0), new Point(0.0, 5.5, 0.0))) 
  }
